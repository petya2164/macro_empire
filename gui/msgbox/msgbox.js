...
function init(data)
{
	...
	let mbConfirmHotkey = Engine.GetGUIObjectByName("mbConfirmHotkey");
	mbConfirmHotkey.onPress = Engine.PopGuiPage;
	...
	captions.forEach((caption, i) => {
		...
		// Convention: Confirm is the last button
		if (i == captions.length - 1)
			mbConfirmHotkey.onPress = action;
